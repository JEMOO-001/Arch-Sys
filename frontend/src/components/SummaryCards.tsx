...
import { FileText, CircleDot, Clock, CheckCircle2, AlertCircle } from 'lucide-react';
...
export const SummaryCards: React.FC<{ stats: SummaryStats }> = ({ stats }) => {
  const cards = [
    ...
    { label: 'Not Started', value: stats.notStarted, icon: CircleDot, color: 'text-gray-600', bg: 'bg-gray-50' },
