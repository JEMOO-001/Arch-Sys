...
namespace ArcLayoutSentinel
{
    ...
    {
        private const string _dockPaneID = "Sentinel_LoginPane";
        ...
        public bool IsTestEnabled { get => _isTestEnabled; set => SetProperty(ref _isTestEnabled, value); }
        ...
        {
            Logger.Debug("LoginDockPaneViewModel.Show()");
